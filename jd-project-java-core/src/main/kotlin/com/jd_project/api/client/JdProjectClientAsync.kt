...
/**
 * A client for interacting with the Jd Project REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface JdProjectClientAsync {
    ...
    /**
     * A view of [JdProjectClientAsync] that provides access to raw HTTP responses for each method.
     */
    interface WithRawResponse {
        ...
        fun st00re(): St00reServiceAsync.WithRawResponse
