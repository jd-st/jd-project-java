...
/**
 * A client for interacting with the Jd Project REST API synchronously. You can also switch to
...
interface JdProjectClient {
     ...
     * this client.
     */
    fun async(): JdProjectClientAsync
    ...
    /** A view of [JdProjectClient] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
        ...
        fun st000re(): St000reService.WithRawResponse
