package com.jd_project.api.core.http

import com.jd_project.api.core.DefaultSleeper
...
import com.jd_project.api.errors.JdProjectRetryableException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        ...
        throwable is IOException ||
            throwable is JdProjectIoException ||
            throwable is JdProjectRetryableException
