...
import com.jd_project.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw JdProjectInvalidDataException(
        ...
        JsonNodeType.POJO,
        null -> throw JdProjectInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
