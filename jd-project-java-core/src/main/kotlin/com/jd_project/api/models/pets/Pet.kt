...
import com.jd_project.api.core.Enum
import com.jd_project.api.core.ExcludeMissing
...
import com.jd_project.api.core.checkKnown
...
private constructor(
    ...
    /**
     * @throws JdProjectInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws JdProjectInvalidDataException if the JSON field has an unexpected type (e.g. if the
     ...
     *
     * @throws JdProjectInvalidDataException if any value type in this object doesn't match its
     *   expected type.
     */
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: JdProjectInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws JdProjectInvalidDataException if this class instance's value is a not a known
         *   member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw JdProjectInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws JdProjectInvalidDataException if this class instance's value does not have the
         *   expected primitive type.
         */
        fun asString(): String =
            _value().asString().orElseThrow {
                JdProjectInvalidDataException("Value is not a String")
            }
    ...
    private constructor(
        ...
        /**
         * @throws JdProjectInvalidDataException if the JSON field has an unexpected type (e.g. if
