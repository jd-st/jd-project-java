...
package com.jd_project.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.jd_project.api.client.JdProjectClientAsync
import com.jd_project.api.client.JdProjectClientAsyncImpl
import com.jd_project.api.core.ClientOptions
import com.jd_project.api.core.Sleeper
import com.jd_project.api.core.Timeout
import com.jd_project.api.core.http.Headers
import com.jd_project.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [JdProjectClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class JdProjectOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [JdProjectClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): JdProjectClientAsync = builder().fromEnv().build()
    }

    /** A builder for [JdProjectOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.jd_project.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [JdProjectClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): JdProjectClientAsync =
            JdProjectClientAsyncImpl(
                clientOptions
                    .httpClient(
