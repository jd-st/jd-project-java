...
import com.jd_project.api.client.JdProjectClientImpl
...
/**
 * A class that allows building an instance of [JdProjectClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class JdProjectOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [JdProjectClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): JdProjectClient = builder().fromEnv().build()
    }

    /** A builder for [JdProjectOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [JdProjectClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): JdProjectClient =
            JdProjectClientImpl(
                clientOptions
                    .httpClient(
