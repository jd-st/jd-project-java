...
import com.jd_project.api.core.http.HttpRequestBody
import com.jd_project.api.core.http.HttpResponse
import com.jd_project.api.core.http.ProxyAuthenticator
import com.jd_project.api.errors.JdProjectIoException
...
internal constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw JdProjectIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(JdProjectIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("JD_PROJECT_LOG")?.lowercase()) {
