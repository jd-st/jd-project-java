...
dependencies {
    testImplementation(project(":jd-project-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../jd-project-java-core/src/main/resources/META-INF/proguard/jd-project-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.jd_project.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../jd-project-java-core/src/main/resources/META-INF/proguard/jd-project-java-core.pro",
