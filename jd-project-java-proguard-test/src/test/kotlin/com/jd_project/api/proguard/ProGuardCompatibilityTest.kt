...
package com.jd_project.api.proguard
...
internal class ProGuardCompatibilityTest {
    ...
    fun proguardRules() {
        val rulesFile =
            javaClass.classLoader.getResourceAsStream("META-INF/proguard/jd-project-java-core.pro")
    ...
    fun client() {
        ...
        assertThat(client.st00000re()).isNotNull()
